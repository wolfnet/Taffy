<cfcomponent hint="Base class for taffy REST application's Application.cfc">
	...
	<cffunction name="matchURI" access="private" output="true" returnType="string">
		...
		<cfloop collection="#application._taffy.endpoints#" item="endpoint">
			<cfset attempt = reMatchNoCase(endpoint, requestedURI) />
			<!--- DEBUG <h3>reMatchNoCase("#endpoint#", "#requestedURI#")</h3><cfdump var="#attempt#">--->
